...
# Team Members
    ...
    - Romain LEFEBVRE
    - Ramaswamy MUTHUKRISHNAN
    - Charlène REMY
    - Souleym ROYER
    - Nishadh Mohammed Jeelani VAHITHA GHULAM
...
## Backgroud
The MxMh dataset published by Mrs. Catherine Rasgaitis is regrouping data from a survey made about a sample of 736 people about the link between music and mental health. Here inside this dataset the following information that are interesting us concerning our study 


#### Age of the participants
Firstly, this dataset contains the age of survey's particpants (for those who stipulated their age). 


#### Listening music while working
They were asked if they were listening music when they are working or not ("while_working" column), simply responding "Yes" or "No". Besides participants were asked to estimated the number of hours daily they were spending listening to music ("hours_per_day" column).


#### Streaming platform preferred
The survey has also asked which music streaming platform were used by sample population ("primary_streaming_service" column). This is represented into our table as "primary_streaming service". Here respondents had the choice between "Spotify", "Pandora","Youtube Music", "Apple Music", "I do not use a streaming service".


#### Favorite style of music
As we mentionned the survey focuses on music, so respondants were asked what was their preferred music (see "fav_genre" column) among the following music genres:
...
### Removal of missing values and Display of clean dataset
...
#### INFERENCE : We can infer that music has a predominantly  positive impact on respondents with respect to the age. However, there is a significant section of young people and adults for whom music had no impact on the state of their mental health. It is worth noting that there's a small population that had a negative impact after listening to music.
...
#### INFERENCE : What can be understood from the self-declarations of the respondents is that music does, in fact, have a noteworthy impact on the mental health condition. Of the 616 responses,  as many as 465 (75.16%) said music improved their mental health, while a lower yet substantial number 136 (22.04%) said music did not have either a positive or negative impact. Meanwhile, only a small section of 15 (2.04%) said listening to music was detrimental to their mental health.
...
# Who did what ?
     ...
     * Romain LEFEBVRE - Performed exploratory data analysis, compared multiple variables and picked the ones with most and least significant impacts for further analysis.
        
        
     * Ramaswamy MUTHUKRISHNAN - Performed exploratory data analysis including cleaning the dataset, generated ggplots for multiple variable combinations, and researched codes for specific functions
      
        
     * Charlène REMY - Cleaned the dataset, brought variable values to the same format to be compared, explored the P-values of variables for most significant variable combinations.
       
        
     * Souleym ROYER - Researched codes for specific functions, studied variables to find possible patterns in distributions, created scales and ranges for comparative study. 
       
        
     * Nishadh Mohammed Jeelani VAHITHA GHULAM - Studied the dataset to develop research questions, suggested correlations between variables, and documented inferences and observations from the resulting tables and graphs.
